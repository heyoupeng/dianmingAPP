    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                id++;
                try{
                    Cursor cursor= db.rawQuery("select _id,Sid,Sname,class from studenttb where _id = ?",new String[]{id+""});
                    while(cursor.moveToNext()){
                        idT.setText(cursor.getInt(cursor.getColumnIndex("_id"))+"");
                        sidT.setText(cursor.getString(1));
                        nameT.setText(cursor.getString(2));
                        classT.setText(cursor.getString(3));
